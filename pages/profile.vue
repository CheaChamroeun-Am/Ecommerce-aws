<template>
  <v-main>
    ...
    <v-container>
            ...
            <v-list border class="mx-auto">
              ...
              >
                <template v-slot:append>
                  <v-badge
                    color="#e5345b"
                    :content="$store.getters['cartCount']"
                    inline
                    data-aos="fade-up"
                    data-aos-delay="500"
                  ></v-badge>
      ...
      <h1 class="mt-15" data-aos="fade-right" data-aos-delay="500">
        Purchase History
      </h1>
...
const { data: purchase } = await useFetch(
  "http://18.208.219.245:3002/api/orders",
  {
    method: "GET",
    headers: {

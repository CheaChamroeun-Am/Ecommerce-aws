import { inject as inject$1, watch, reactive, getCurrentInstance as getCurrentInstance$1, version as version$1, toRef, isRef, createVNode, mergeProps, toRefs, Transition, ref, computed, nextTick, Text, watchEffect, provide, onScopeDispose, withDirectives, vShow, resolveDirective, capitalize, h, shallowRef, isReadonly, defineComponent as defineComponent$1, camelize, unref, toRaw, readonly, TransitionGroup, Fragment as Fragment$1, resolveDynamicComponent, cloneVNode, effectScope, warn, toHandlers, Teleport, createTextVNode, vModelText, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, defineAsyncComponent, withCtx, Suspense } from 'vue';
...
function useStore (key) {
  ...
  return inject$1(key !== null ? key : storeKey)
}
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./about-373d5226.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-id",
    path: "/blog/:id",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./contact-6e4b1290.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./signup-f52aef5a.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./thanksyou-d9f1086a.mjs').then((m) => m.default || m)
  }
];
...
const vuetify_7h9QAQEssH = defineNuxtPlugin((nuxtApp) => {
...
const vuex_owYp5qnaH8 = defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: () => import('./default-7b3f922f.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-22b72f16.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-1fcfe613.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useStore as a, useRouter$1 as b, useNuxtApp as c, createError as d, useRequestFetch as e, defineNuxtRouteMiddleware as f, useState as g, navigateTo as n, server as s, useRoute as u };

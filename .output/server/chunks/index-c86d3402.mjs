...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    useStore();
    useRoute();
    const { data: products } = ([__temp, __restore] = withAsyncContext(() => useFetch("http://3.90.217.148:3002/api/products", "$PslAyef5YX")), __temp = await __temp, __restore(), __temp);
    const handleFollow = () => {
...
//# sourceMappingURL=index-c86d3402.mjs.map

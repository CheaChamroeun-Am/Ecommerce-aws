  ...
  <v-app>
    <v-card class="mx-auto" flat>
      ...
      <div class="text-center">
        <p class="text-uppercase font-weight-bold" style="font-size: 30px">
          Page not found
        </p>
        <p class="text-grey">
        ...
        <p class="text-grey">
          If you think something is broken, report a <br />
          problem
        </p>

        <div class="d-flex justify-space-between mt-5">
          <v-btn
            class="mt-5 px-5 text-white"
            color="#e5345b"
            rounded="pill"
            @click="goHome"
          >
          ...
          <v-dialog v-model="dialog" width="auto">
            ...
            <v-card class="pa-5" width="700px">
              ...
              <v-card-actions class="d-flex justify-end">
                <v-btn color="#e5345b" @click="handleSend">Send</v-btn>
              </v-card-actions>
            </v-card>
          </v-dialog>
        </div>
    ...
    <v-snackbar v-model="snackbar" color="green">
      Thanks you for your report. We will fix it as soon as possible.
